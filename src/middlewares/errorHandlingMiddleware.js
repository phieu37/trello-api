/**
 * NOTE: (Muốn hiểu rõ hơn về code trong file này thì vui lòng xem video 54
 * trong bộ MERN Stack)
*/
...
export const errorHandlingMiddleware = (err, req, res, next) => {
  ...
  const responseError = {
    ...
    message: err.message || StatusCodes[err.statusCode], // Nếu lỗi có message thì lấy, nếu không có message thì lấy chuẩn theo mã Status Code(500 ở trên)
    stack: err.stack // báo cụm lỗi cho dev
  }
